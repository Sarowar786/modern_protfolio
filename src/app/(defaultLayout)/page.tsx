        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2">
            ...
            <p className="text-muted text-lg mb-6 leading-relaxed">
              I specialize in building robust backend systems and pixel-perfect
              frontends. My goal is to create products that provide value and a
              great user experience.
            </p>
            <MagneticEffect>
              <Link href="/about">
                <Button className="animated-border hover:shadow-[0_0_20px_var(--accent)] bg-card text-foreground hover:bg-card/90 px-8 py-6 text-lg transition-all rounded!">
                  Read My Story <MoveRight />{" "}
                </Button>
              </Link>
            </MagneticEffect>
          </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto bg-brand-gradient p-12 rounded-[3rem] text-center">
          ...
          <Link href="/contact">
            <Button
              size="lg"
              className="bg-white text-primary hover:bg-white/90 px-10 py-7 text-xl rounded-full"
            >
              Contact Me Now
            </Button>
          </Link>
